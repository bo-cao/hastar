...
from revised_hastar.robot import Robot
...
class HybridAstar:
    ...
    def __init__(self, car, grid, reverse, obs, unit_theta=pi/12, dt=1e-2, check_dubins=1):
    ...
    def get_children(self, node, extra):
    ...
    def update_obs(self, obs):
        """ Update obstacles. """
        self.obs = obs
        self.grid.get_obstacle_occupancy()
    ...
    def search_path(self, heu=1, extra=False):
        ...
        while open_:
            ...
            children = self.get_children(best, extra)
...
if __name__ == '__main__':
    # 机器人起点终点
    start_pos, end_pos = [0, 0, 0], [10, 10, 0]
    ...
    robot = Robot(start_pos=start_pos, end_pos=end_pos, l=l, max_phi=max_phi)

    hastar = HybridAstar(car=robot, grid=None, reverse=False, obs=None)
    hastar.update_obs(obs) # 更新动态占用
